...
import { ArrowLeft, Calendar, Plus, Edit, Trash2, Save, Clock } from "lucide-react"
...
export default function SchedulePage() {
  ...
  const DayScheduleCard = ({ day, dayData }) => {
    ...
    return (
      <Card className="border-0 bg-card/80 dark:bg-gradient-to-br dark:from-slate-900/80 dark:to-slate-800/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
        <CardHeader className="pb-3">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
            <div className="flex items-center space-x-3">
              ...
              />
              <Label className="text-foreground dark:text-white font-medium text-sm sm:text-base">{day.label}</Label>
            </div>
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button
                      size="sm"
                      variant="outline"
                      className="border-border dark:border-slate-600 text-foreground dark:text-slate-300 bg-transparent hover:bg-muted dark:hover:bg-slate-700/50"
                  ...
                  <DialogContent className="bg-background dark:bg-slate-800 border-border dark:border-slate-700 max-w-md">
                    <DialogHeader>
                      <DialogTitle className="text-foreground dark:text-white">Edit {day.label} Schedule</DialogTitle>
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <Label className="text-foreground dark:text-slate-300 text-sm">Start Time</Label>
                          <Input
                            type="time"
                        ...
                        <div>
                          <Label className="text-foreground dark:text-slate-300 text-sm">End Time</Label>
                          <Input
                            type="time"
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <Label className="text-foreground dark:text-slate-300 text-sm">Break Start</Label>
                          <Input
                            type="time"
                        ...
                        <div>
                          <Label className="text-foreground dark:text-slate-300 text-sm">Break End</Label>
                          <Input
                            type="time"
                      ...
                      <div>
                        <Label className="text-foreground dark:text-slate-300 text-sm">Slot Duration (minutes)</Label>
                        <Select
        ...
        {dayData.enabled && (
          <CardContent>
            <div className="space-y-2">
              <div className="text-muted-foreground dark:text-slate-400 text-xs sm:text-sm">
              ...
              <div className="flex flex-wrap gap-1 mt-2">
                {timeSlots.slice(0, 6).map((slot, index) => (
                  <Badge key={index} variant="outline" className="border-teal-500/30 text-teal-600 dark:text-teal-300 text-xs">
                    {slot.start}
                  </Badge>
                ))}
                {timeSlots.length > 6 && (
                  <Badge variant="outline" className="border-border dark:border-slate-500/30 text-muted-foreground dark:text-slate-400 text-xs">
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-4 sm:py-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 sm:mb-8 space-y-4 sm:space-y-0">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-muted-foreground dark:text-slate-400 text-sm sm:text-lg mt-1 sm:mt-2">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div className="xl:col-span-3">
              <Card className="border-0 bg-card/80 dark:bg-gradient-to-br dark:from-slate-900/80 dark:to-slate-800/80 backdrop-blur-sm shadow-2xl mb-6 sm:mb-8">
                <CardHeader>
                  <CardTitle className="text-xl sm:text-2xl font-bold text-foreground dark:text-white flex items-center">
                    <Calendar className="w-5 h-5 sm:w-6 sm:h-6 mr-2 sm:mr-3 text-teal-400" />
                    Weekly Schedule
                  </CardTitle>
                  <CardDescription className="text-muted-foreground dark:text-slate-400 mt-2 text-sm sm:text-base">
            ...
            <div className="space-y-6">
              ...
              <Card className="border-0 bg-card/80 dark:bg-gradient-to-br dark:from-slate-900/80 dark:to-slate-800/80 backdrop-blur-sm shadow-2xl">
                <CardHeader>
                  <CardTitle className="text-lg sm:text-xl font-bold text-foreground dark:text-white">Quick Stats</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground dark:text-slate-300 text-sm">Active Days</span>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground dark:text-slate-300 text-sm">Total Slots</span>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground dark:text-slate-300 text-sm">Blocked Dates</span>
                    <Badge className="bg-red-500/20 text-red-600 dark:text-red-300 border-red-500/30">{blockedDates.length}</Badge>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 bg-card/80 dark:bg-gradient-to-br dark:from-slate-900/80 dark:to-slate-800/80 backdrop-blur-sm shadow-2xl">
                <CardHeader>
                  <CardTitle className="text-lg sm:text-xl font-bold text-foreground dark:text-white">Block Dates</CardTitle>
                  <CardDescription className="text-muted-foreground dark:text-slate-400 text-sm">
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    <Input
                      ...
                      className="bg-muted/50 dark:bg-slate-700 border-border dark:border-slate-600 text-foreground dark:text-white text-sm"
                  ...
                  {blockedDates.length > 0 && (
                    <div className="space-y-2 max-h-48 overflow-y-auto">
                      {blockedDates.map((block) => (
                        <div
                          key={block.id}
                          className="flex items-center justify-between p-2 bg-muted/30 dark:bg-slate-800/30 rounded text-sm"
                        >
                          <div>
                            <div className="text-foreground dark:text-white font-medium">{new Date(block.date).toLocaleDateString()}</div>
                            <div className="text-muted-foreground dark:text-slate-400 text-xs">{block.reason}</div>
                          </div>
                          <Button
                            size="sm"
                            variant="outline"
                            onClick={() => removeBlockedDate(block.id)}
                            className="border-red-500/30 text-red-600 dark:text-red-300 hover:bg-red-500/10"
                          >
